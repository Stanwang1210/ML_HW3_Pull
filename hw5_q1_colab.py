...
Original file is located at
    https://colab.research.google.com/drive/1XMZQiqRF9F78x2pPfy3q5ecQz8TZE4qQ
...
args = {
      'ckptpath': 'model1_2drop_0.2_reg_norm.pt',
      'dataset_dir': 'food-11/'
}
...
img_indices1 = [1452,2079, 2765, 3487]
images, labels = train_set.getbatch(img_indices1)
saliencies = compute_saliency_maps(images, labels, model)
...
for id in range(30):
    ...
    filter_activations, filter_visualization = filter_explaination(images, model, cnnid=id, filterid=0, iteration=100, lr=0.1)
...
dictionary = {"Bread":[0, 100, 200, 300, 400],	
              "Fruit" : [1000, 1100, 1200, 1300, 1400],
              "Dessert":[2200, 2300, 2400, 2500, 2600],
              "Diary product": [1800, 1850, 1900, 1950, 2000],	
              "Egg" :[4002, 4052, 4102, 4152, 4202],	
              "Fried food": [4700, 4750, 4800, 4850, 4900],	
              "Meat": [5700, 5750, 5800, 5850, 5900],	
              "Pasta": [7001, 7051, 7101, 7151, 7201],
              "SeaFood": [7700, 7750, 7800, 7850, 7900],
...
for key in dictionary.keys():                                                                                                                                                                       
    ...
    plt.imshow(images.permute(0, 2, 3, 1))
